...
import net.voldrich.template.backend_spring.jooq.tables.RefreshTokens;
import net.voldrich.template.backend_spring.jooq.tables.records.RefreshTokensRecord;
