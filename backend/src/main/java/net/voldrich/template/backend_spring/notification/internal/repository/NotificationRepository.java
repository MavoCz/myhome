package net.voldrich.template.backend_spring.notification.internal.repository;

import net.voldrich.template.backend_spring.jooq.tables.Notifications;
import net.voldrich.template.backend_spring.jooq.tables.records.NotificationsRecord;
...
public class NotificationRepository {
    ...
    public NotificationsRecord create(Long userId, Long familyId, String type, String title, String message, String data) {
        return dsl.insertInto(N)
                .set(N.USER_ID, userId)
                .set(N.FAMILY_ID, familyId)
                .set(N.TYPE, type)
                .set(N.TITLE, title)
